...
public class CellPostMain extends ListActivity implements OnTouchListener{
    ...
    private static final String ACTION_LIST_ACCOUNTS = "pl.app.cellpost.LIST_ACCOUNTS";
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		switch(position) {
			...
			case 3: System.out.println("Sent");
					break;
			case 4: startActivity(new Intent(ACTION_LIST_ACCOUNTS));
					break;
		}
